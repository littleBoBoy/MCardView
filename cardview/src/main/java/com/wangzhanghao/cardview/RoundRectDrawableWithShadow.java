...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize, ColorStateList shadowColorStart, ColorStateList shadowColorEnd) {
...
//        this.mEdgeShadowPaint.setAntiAlias(false);
        ...
        mEdgeShadowPaint.setShader(new LinearGradient(0, -mCornerRadius + mShadowSize, 0,
                ...
                new int[]{starColor, starColor, endColor},
                new float[]{0f, .5f, 1f}, TileMode.CLAMP));
